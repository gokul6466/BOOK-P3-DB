...
const { getallbooks,getsinglebookbyid,getallissuedbooksbyid,addnewbook,updatebookbyid } = require("../controllers/Book-controller");
...
router.get("/issued/by-user",getallissuedbooksbyid);
